...
param namePrefix string = 'crcopilot'
...
param backendTargetPort int = 8030
      ...
      containers: [
        {
          ...
          image: backendImage
          env: [
            { name: 'CHECKOUT_COPILOT_API_TOKEN', secretRef: 'api-token' }
            { name: 'CHECKOUT_COPILOT_EXECUTION_MODE', value: 'copilot' }
            { name: 'CHECKOUT_COPILOT_ENVIRONMENT', value: 'production' }
            { name: 'ENABLE_SENSITIVE_DATA', value: 'false' }
            {
              name: 'CHECKOUT_COPILOT_DATABASE_URL'
              secretRef: 'database-url'
            }
            {
              name: 'CHECKOUT_COPILOT_FOUNDRY_PROJECT_ENDPOINT'
              value: foundryProjectEndpoint
            }
            {
              name: 'CHECKOUT_COPILOT_FOUNDRY_MODEL_DEPLOYMENT'
              value: foundryModelDeployment
            }
            {
              name: 'CHECKOUT_COPILOT_MAX_AUTO_INVENTORY_QUANTITY'
            ...
            }
            {
              ...
              value: 'checkout-recovery-copilot-api'
            }
            {
