...
from checkout_recovery_copilot.projections import project_artifact, project_case, project_event
...
def test_inventory_recovery_above_safe_bound_routes_to_manual_review(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "checkout_recovery_copilot.application.service.get_checkout_fixture",
