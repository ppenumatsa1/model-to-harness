...
if TYPE_CHECKING:
    from checkout_recovery_copilot.projections import (
...
class CheckoutRecoveryService:
    """Application-owned recovery state machine; Copilot state is deliberately not read."""
    ...
    def __init__(
        ...
        *,
        ...
        harness_mode: Literal["scripted", "copilot"] | None = None,
        ...
        self._harness_mode = harness_mode or ("scripted" if investigator is None else "unknown")
        if investigator is None:
            from checkout_recovery_copilot.sdk.investigation import ScriptedInvestigator
    ...
    def list_event_responses(self, case_id: str) -> list[SafeAuditEventResponse]:
        from checkout_recovery_copilot.projections import project_event
    ...
    def get_workspace_artifact_response(self, case_id: str) -> SafeWorkspaceArtifactResponse:
        from checkout_recovery_copilot.projections import project_artifact
