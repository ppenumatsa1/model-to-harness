...
class RootSharedActions:
    ...
    @classmethod
    def for_fixture(cls, fixture_id: str) -> RootSharedActions:
    ...
    def find_refund(self, idempotency_key: str) -> dict[str, Any] | None:
        refund = next(
            (
                item
                for item in self.billing.refunds
...
class ActionRegistry:
    def __init__(self) -> None:
        self._actions: dict[str, RootSharedActions] = {}

    def create(self, run_id: str, fixture_id: str) -> RootSharedActions:
        actions = RootSharedActions.for_fixture(fixture_id)
        self._actions[run_id] = actions
        return actions

    def get_or_restore(self, run_id: str, fixture_id: str) -> RootSharedActions:
        return self._actions.setdefault(run_id, RootSharedActions.for_fixture(fixture_id))
